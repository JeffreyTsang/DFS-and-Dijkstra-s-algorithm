...
public class MinPath {
    ...
    public static List<Node> minPath(Node first, Node last) {
        ...
        //Should your spaceship sit at Planet X and calculate the best way to get as many gems as possible 
        //and then traverse the graph? Or should it do a small bit of calculation, traverse a path, and repeat the process?
